...
class SeedStore:
    ...
    def get(self, key):
        ...
        try:
            ...
            connection.close()
        if key == "workspace":
            payload[key].update(active_version=active_version, environment=f"Robot PDF Demo · {active_version}")
        elif key == "versions":
