...
export default function App() {
  const [data, setData] = useState<AppData | null>(null); const [error, setError] = useState(""); const [page, setPage] = useState<Page>("assistant"); const [preview, setPreview] = useState(false); const [openedCaseId, setOpenedCaseId] = useState<string>(); const [openedDocument, setOpenedDocument] = useState<{ name?: string; citation?: Citation }>();
