...
export function OverviewPage({ data, navigate }: { data: any; navigate: (page: any) => void }) {
  ...
  return <div className="page"><div className="eyebrow">园区运营知识助手</div><div className="page-title"><div><h1>RAG 质量概览</h1><p>由评测驱动，从基线优化到经验证的候选方案。</p></div><div className="production"><span>演示启用配置</span><strong>{active?.id || "未启用"} {displayText(active?.name || "")}</strong></div></div>
